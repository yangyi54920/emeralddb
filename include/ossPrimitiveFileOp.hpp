...
#define oss_struct_statfs              struct stattfs64
...
class ossPrimitiveFileOp
{
    ...
    private:
        ...
        const ossPrimitiveFileOp &operator=(const ossPrimitiveFileOp &);  //don't create a = b;
        bool _bIsStdout;
    ...
    public:
        ...
        offsetType getCuttentOffset(void) const;
