...
int ICommand::getError(int code)
{
    switch(code)
    {
        ...
        case EDB_NO_ID:
        	std::cout << "_id is not exist." << std::endl;
        	break;
	
        case EDB_QUERY_INVALID_ARGVMENT:
        	std::cout << "invalid query argument." << std::endl;
        	break;
	
        case EDB_INSERT_INVALID_ARGVMENT:
        	std::cout << "invalid insert argument." << std::endl;
        	break;
	
        case EDB_DELETE_INVALID_ARGVMENT:
        	std::cout << "invalid query argument." << std::endl;
        	break;
...
int HelpCommand::execute(ossSocket &sock, std::vector<std::string> &argVec)
{
    ...
    printf("Tyoe \"help\" command for help\n");
    return ret;
}
